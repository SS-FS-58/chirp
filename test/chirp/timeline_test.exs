defmodule Chirp.TimelineTest do
  ...
  describe "posts" do
    ...
    @valid_attrs %{body: "some body", likes_count: 42, reposts_counter: 42, username: "some username"}
    @update_attrs %{body: "some updated body", likes_count: 43, reposts_counter: 43, username: "some updated username"}
    @invalid_attrs %{body: nil, likes_count: nil, reposts_counter: nil, username: nil}
    ...
    test "create_post/1 with valid data creates a post" do
      ...
      assert post.reposts_counter == 42
    ...
    test "update_post/2 with valid data updates the post" do
      ...
      assert post.reposts_counter == 43
